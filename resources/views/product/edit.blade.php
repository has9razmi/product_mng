            ...
            <form action="{{ route('product.update', ['product' => $product->id]) }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                        ...
                        is-invalid
                    @enderror"
                        id="productId" placeholder="Product ID" name="product_id" value="{{ $product->product_id }}">
                    @error('product_id')
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                        ...
                        is-invalid
                    @enderror"
                        id="productName" placeholder="Product Name" name="name" value="{{ $product->name }}">
                    @error('name')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description')
                        is-invalid
                    @enderror"
                        id="productDescription" rows="3" name="description">{{ $product->description }}</textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input
                        ...
                        is-invalid
                    @enderror"
                        type="file" id="productImage" name="image" value="{{ $product->image }}">
                    @error('image')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
